...
function navbar($currentType, $category = "", $forum = "", $topic = "") {
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            ';
    if(isset($currentCategoryName) && !empty($currentCategoryName)) {
        echo '
        ...
        echo '"><a class="nav-link" href="#">'.$currentCategoryName.'
                </a>
            </li>
        ';
    }

    if(isset($currentForumName) && !empty($currentForumName)) {
        echo '
            <span class="navbar-text">/</span>
            <li class="nav-item';
        if($currentType == 'forum') {
            echo ' active';
        }
        echo '"><a class="nav-link" href="#">'.$currentForumName.'
                </a>
            </li>
        ';
    }

    if(isset($currentTopicName) && !empty($currentTopicName)){
        echo '
            <span class="navbar-text">/</span>
            <li class="nav-item';
        ...
        echo '"><a class="nav-link" href="#">'.$currentTopicName.'
                </a>
            </li>
        ';
    }
...
<?php navbar('forum', 'Announcements', 'Important', 'Changes to the forum');    ?>
